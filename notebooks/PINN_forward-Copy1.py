# Converted from PINN_forward-Copy1.ipynb (repo path: notebooks/PINN_forward-Copy1.ipynb) on 2026-09-23.
...
# Run from this directory:  cd notebooks && python3 PINN_forward-Copy1.py
