# Converted from PINN_solution.ipynb (repo path: PINN/PINN_solution.ipynb) on 2026-09-23.
...
# Run from this directory:  cd PINN && python3 PINN_solution_notebook.py

# %% [cell 1]
# [ipython-only, skipped] !uv pip install numpy

# %% [cell 2]
# [ipython-only, skipped] !uv pip install scipy --python /opt/venv/bin/python --target ~/.local/lib/python3.12/site-packages
