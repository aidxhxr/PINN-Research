...
\sbox{\TitleBox}{\begin{minipage}{\LiveWidth}\centering\color{white}
  ...
  Amirkhan Aidarkhan\enspace\textperiodcentered\enspace Pascal K. Kataboh\par}
\end{minipage}}
...
\par\vspace{2pt}\includegraphics[width=\linewidth]{assets/atra-treatment.pdf}
\PanelEnd}
...
\Caption{Squared data/IC losses; autodiff physics. IC weight 20 heuristically emphasizes the initial state.}
