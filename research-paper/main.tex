...
proliferation, differentiation, stemness, and signaling pathways
\cite{ordonez2015hoxa5,facey2020retinoids,xu2022atra}. Accordingly, the treatment
...
signaling responses over short in vitro windows \cite{ordonez2015hoxa5,facey2020retinoids,xu2022atra}.
...
expression \cite{ordonez2015hoxa5}. Facey and Boman reviewed evidence that RA
...
\]
denotes the state vector consisting of $\beta$-catenin, APC, HOXA5, HOXA13,
MYC, RA, and CYP26A1, and $\theta$ denotes the vector of model parameters.
...
Last part - Discussion - restate what we talked about, discuss importance of our model, limitations of the model - and future direction (Hybrid Mechanistic, Stochastic Modeling)... must incorporate biological significance to these future methods.
