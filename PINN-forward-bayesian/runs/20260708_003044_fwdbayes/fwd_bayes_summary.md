...
|---|---|---|---|---|---|---|
| Normal | 0.90 | 3 | 400 | 0.73 | 0.002 | 0.005 |
| Early adenoma | 0.91 | 3 | 400 | 0.63 | 0.002 | 0.003 |
| Cancer-like | 0.93 | 3 | 400 | 0.63 | 0.002 | 0.003 |
| Strong APC-mutant | 0.91 | 3 | 400 | 0.56 | 0.002 | 0.002 |

## Per-state 95% coverage (rows = state, cols = regime)

| state | Normal | Early adenoma | Cancer-like | Strong APC-mutant |
|---|---|---|---|---|
| b | 0.70 | 0.51 | 0.60 | 0.51 |
| apc | 0.62 | 0.50 | 0.65 | 0.62 |
| h5 | 0.63 | 0.59 | 0.55 | 0.44 |
| h13 | 0.84 | 0.77 | 0.63 | 0.57 |
| m | 0.84 | 0.70 | 0.65 | 0.57 |
| r | 0.72 | 0.65 | 0.71 | 0.67 |
