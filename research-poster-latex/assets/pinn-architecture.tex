% Editable vector schematic of the integral inverse PINN; neuron counts abbreviated.
% Architecture checked against PINN-inverse-pinn-boost/model.py and training.py.
\begingroup
...
\node[loss,draw=Garnet!65,fill=Garnet!7] (physics) at (12.60,1.34)
  {\textbf{Integral ODE}\\$\lambda_{\rm phys}\mathcal L_{\rm phys}$};
...
\node[font=\fontsize{25}{31}\selectfont] at (2.91,.47)
  {$\mathcal L=\mathcal L_{\rm data}+\lambda_{\rm phys}\mathcal L_{\rm phys}+20\mathcal L_{\rm IC}$};
\end{tikzpicture}%
\endgroup
