# Converted from smallAnalytical.ipynb (repo path: PINN-smaller/smallAnalytical.ipynb) on 2026-09-23.
...
# Run from this directory:  cd PINN-smaller && python3 smallAnalytical.py
