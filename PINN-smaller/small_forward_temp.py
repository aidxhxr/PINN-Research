# Converted from small_forward_temp.ipynb (repo path: PINN-smaller/small_forward_temp.ipynb) on 2026-09-23.
...
# Run from this directory:  cd PINN-smaller && python3 small_forward_temp.py
